...
class MainActivity : AppCompatActivity() {
    ...
    private fun setListeners() {
        val clicableViews : List<View> = listOf(box_one_text, box_two_text, box_three_text,
            box_four_text, box_five_text, red_button, green_button,
            yellow_button, constrain_layout)
